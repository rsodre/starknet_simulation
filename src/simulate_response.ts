#!/usr/bin/env node
import { RpcProvider, type SimulateTransactionOverhead } from "starknet";
import { RPC_URL_MAINNET } from "./constants/index.js";
...
const main = async () => {
  const provider = new RpcProvider({ nodeUrl: RPC_URL_MAINNET });
