...
export const ERC20_ADDRESS = "0x028e156a25dfde6fc4a06fead9df08e0f77b31dda5d09f36878e3cdea819a781";
...
export const ROUTER_ADDRESS = "0x0449e1627f49a8597809b0df7236f9e3ad42ecf935b000cd9f89060efb87987b";
...
export const erc20_transfers: Call[] = [
  ...
  { "contractAddress": STRK_ADDRESS, "entrypoint": "transfer", "calldata": [RECIPIENT1, 3n * ONE_ETH, "0x0"] },
];
...
export const erc20_approvals: Call[] = [
  ...
  { "contractAddress": STRK_ADDRESS, "entrypoint": "approve", "calldata": [RECIPIENT1, 3n * ONE_ETH, "0x0"] },
];

// send STRK, receive ERC20
export const erc20_swap_transferred: Call[] = [
  { "contractAddress": STRK_ADDRESS, "entrypoint": "transfer", "calldata": [ROUTER_ADDRESS, ONE_ETH, "0x0"] },
  { "contractAddress": ROUTER_ADDRESS, "entrypoint": "swap_transferred", "calldata": [ONE_ETH, "0x0"] },
];
export const erc20_swap_transferred_over: Call[] = [
  { "contractAddress": STRK_ADDRESS, "entrypoint": "transfer", "calldata": [ROUTER_ADDRESS, 5n * ONE_ETH, "0x0"] },
  { "contractAddress": ROUTER_ADDRESS, "entrypoint": "swap_transferred", "calldata": [ONE_ETH, "0x0"] },
];

// send STRK, receive ERC20
export const erc20_swap_approved: Call[] = [
  { "contractAddress": STRK_ADDRESS, "entrypoint": "approve", "calldata": [ROUTER_ADDRESS, ONE_ETH, "0x0"] },
  { "contractAddress": ROUTER_ADDRESS, "entrypoint": "swap_approved", "calldata": [ONE_ETH, "0x0"] },
];
export const erc20_swap_approved_over: Call[] = [
  { "contractAddress": STRK_ADDRESS, "entrypoint": "approve", "calldata": [ROUTER_ADDRESS, 4n * ONE_ETH, "0x0"] },
  { "contractAddress": ROUTER_ADDRESS, "entrypoint": "swap_approved", "calldata": [ONE_ETH, "0x0"] },
];
...
export const erc721_purchase_transferred: Call[] = [
  { "contractAddress": STRK_ADDRESS, "entrypoint": "transfer", "calldata": [ROUTER_ADDRESS, ONE_ETH, "0x0"] },
  { "contractAddress": ROUTER_ADDRESS, "entrypoint": "purchase_erc721_transferred", "calldata": [] },
];
...
export const erc721_purchase_approved_over: Call[] = [
  { "contractAddress": STRK_ADDRESS, "entrypoint": "approve", "calldata": [ROUTER_ADDRESS, 5n * ONE_ETH, "0x0"] },
  { "contractAddress": ROUTER_ADDRESS, "entrypoint": "purchase_erc721_approved", "calldata": [ONE_ETH, "0x0"] },
];
